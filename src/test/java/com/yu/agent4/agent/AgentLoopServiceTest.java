...
//    /** 单元测试用的无操作 SessionStore，不产生真实文件 */
//    private static final SessionStore noopStore = new SessionStore() {
//        @Override
...
//                new ContextAssembler(properties, toolRegistry, new TodoManager()), noopStore
//        );
//
//        List<Message> history = new ArrayList<>();
//        AgentLoopTurnResult result = agentLoopService.runTurn(history, "list current directory", "test-session");
//
...
//                new ContextAssembler(properties, toolRegistry, todoManager), noopStore
//        );
//
//        agentLoopService.runTurn(new ArrayList<>(), "new task", "test-session");
//
...
//        );
//
//        AgentLoopTurnResult result = agentLoopService.runTurn(new ArrayList<>(), "complex task", "test-session");
//
...
//        );
//
//        agentLoopService.runTurn(new ArrayList<>(), "读取 hello.py", "test-session");
//
//        assertTrue(!chatModel.firstSystemPrompt.contains("Todo kickoff reminder:"));
//    }
//
